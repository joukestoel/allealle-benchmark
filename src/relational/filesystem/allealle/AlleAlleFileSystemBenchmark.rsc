module relational::filesystem::allealle::AlleAlleFileSystemBenchmark
...
str getConstraints(int config)
  = "Object = File ∪ Dir
    ...
    '  (¬(d ⊆ (d ⨝ ^\<oId,parent\>parent)[parent][parent as oId])) ∧ 
    '  ((¬ d = Root) ⇒ Root ⊆ (d ⨝ ^\<oId,parent\>parent)[parent][parent as oId]) 
    '    
